...
app.get("/scrape", function (req, res) {
  ...
  axios.get("https://www.nytimes.com/").then(function (response) {
    ...
    $("article.theme-summary").each(function (i, element) {
      ...
      result.title = $(this).children(".story-heading").children("a").text();
      result.link = $(this).children(".story-heading").children("a").attr("href");
      result.summary = $(this).children("p.summary").text();
      // console.log(result);
      //  if article with theme summary doesnt exist dont insert to db 
...
app.get("/save", function (req, res) {
  ...
  // Create a new note and pass the req.body to the entry
    db.Article.find({"saved" : true }).then(function (dbArticle) {
      ...
      console.log(dbArticle);
      res.json(dbArticle);
      //console.log("in server saved articles")
      //res.redir(path.join(__dirname, "./views/savedarticles.html"));
